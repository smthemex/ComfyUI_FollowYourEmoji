...
# import folder_paths
# weight_path=os.path.join(folder_paths.models_dir,"follow_emoji")
...
class ReferenceNet2DConditionModel(ModelMixin, ConfigMixin, UNet2DConditionLoadersMixin):
    ...
    def from_pretrained_2d(
        ...
        config_file =os.path.join(pretrained_model_path)
        ...
        if not os.path.exists(pretrained_model_path):
            ...
            state_dict = torch.load(os.path.join(pretrained_model_path,"diffusion_pytorch_model.bin")
                        ,
                        map_location="cpu",
                        weights_only=True,
                    )
